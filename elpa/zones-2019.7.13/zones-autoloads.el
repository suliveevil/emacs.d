;;; zones-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn ID &optional VARIABLE MSGP)" t)
...
(fn START END &optional VARIABLE NOT-BUF-LOCAL-P SET-VAR-P MSG)" t)
...
Note that if the value of `zz-izones-var' is not buffer-local then you
can use this command to cycle among zones in multiple buffers." t)
...
This is a repeatable version of `zz-select-zone'." t)
...
(fn FROM-VARIABLE TO-VARIABLE &optional MSGP)" t)
...
(fn START END &optional VARIABLE MSG)" t)
...
(fn REGEXP &optional VARIABLE BEG END NOT-BUF-LOCAL-P SET-VAR-P SUBEXP MSGP)" t)
...
(fn &optional START END FACE ONLY-HLT-FACE OVERLAY/TEXT FONK-LOCK-P MSGP)" t)
...
(fn FACE &optional START END VARIABLE)" t)
...
`Zz-Auto-Add-Region-As-Izone mode' mode.  If the prefix argument
...
evaluate `zz-auto-add-region-as-izone-mode'.
...
(fn &optional INTERACTIVEP)" t)
(register-definition-prefixes "zones" '("zz-"))

;;; End of scraped data

(provide 'zones-autoloads)
